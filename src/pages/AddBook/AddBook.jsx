...
const AddBook = () => {
    ...
    // const {user}=useContext(AuthContext)
      ...
      return (
        <div className=''>
            <h4 className='text-center font-serif text-4xl mt-12'>Add Book </h4>
    ...
    <option value="other">other</option>
        ...
        {/**  --------------------  */}
          ...
          <div className="mt-6 form-control">
            <button className="btn btn-primary hover:bg-red-500 bg-yellow-500 w-60 mx-auto text-black">Add Bood</button>
          </div>
        </form>
      </div>
